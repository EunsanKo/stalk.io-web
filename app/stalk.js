...
var STALK_CONFIGURATION = {
  APP: 'stalk-io',
  STALK_URL: 'http://link.stalk.io:8080',
  APP_URL: 'http://www.notdol.comio:8000',
...
var LSTALK = (function(CONF, UTILS, WIN) {
  ...
  return {
    ...
    init: function(data) {
      ...
      UTILS.loadJson(CONF.STALK_URL+'/operator/session/'+data.key+'?1=1', 'LSTALK.callbackOperator');
...
})(STALK_UTILS.deepCopy(STALK_CONFIGURATION), STALK_UTILS, STALK_WINDOW);
